...
https://github.com/Abhishek176/terraform-cloud-demo.git
```
...
- **Organization Name:** myapp-demo
- **Email Address:** muduliabhishek@gmail.com
...
- **Connect to VCS**
  ...
  - **Selected 1 Repository:** Abhishek176/terraform-cloud-demo
  - Click on **Install**
- **Choose a Repository**
  - Abhishek176/terraform-cloud-demo
- **Configure Settings**
