...
Go to AWS Mgmt Console -> Services -> S3 -> terraform-Apache -> workspaces -> terraform.tfstate
```
...
Go to AWS Mgmt Console -> Services -> S3 -> terraform-Apache -> env:/ -> dev -> workspaces -> terraform.tfstate
```
